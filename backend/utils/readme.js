...
async function updateFileDescription(dataPath, projectName, taskName, fileName, description) {
...
async function removeFileDescription(dataPath, projectName, taskName, fileName) {
  const readmePath = path.join(dataPath, projectName, taskName, 'README.md');
